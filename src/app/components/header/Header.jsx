  ...
  return (
     ...
     {/* <div className='header3'>
          <div className='k2'>
             ...
             <div className='accontt'>
   
                  <div className='y1'>
                   <button className='logup1'>ثبت نام</button>
                   <button className='login1'>ورود</button>
                  </div>
                  <div>
                   <i className=" 	far  fa-user   profile1  "  ></i>
                       
                  </div>
             </div>

          <div>
               <svg className='shoping-cart1' xmlns="http://www.w3.org/2000/svg" viewBox="0 -960  
          960 960"  fill="#00f"><path d="M286.79-81Q257-81
           236-102.21t-21-51Q215-183 
          236.21-204t51-21Q317-225 338-203.79t21
           51Q359-123 337.79-102t-51 21Zm400 0Q657-81 
    ...
    {/* <div  className='header'>  
           <div className='accont1'>

     <div className='account'>
          <div className='log'>
           
           <button className='logup'>ثبت نام</button>
           <button className='login'>ورود</button>
           </div> 
         ...
         <img src="./img/logo6.png" alt="not"  className='logo'/>
            ...
            <div className='meno1'>
               <h2 className='meno'>&#9776;</h2>
                     <svg className='shoping-cart' xmlns="http://www.w3.org/2000/svg" viewBox="0 -960  
          960 960"  fill="#00f"><path d="M286.79-81Q257-81
           236-102.21t-21-51Q215-183 
          236.21-204t51-21Q317-225 338-203.79t21
           51Q359-123 337.79-102t-51 21Zm400 0Q657-81 
